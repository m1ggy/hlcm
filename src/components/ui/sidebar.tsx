  ...
  return (
    <main
      ...
      className={cn(
        ...
        // min-width is "auto" (its content's intrinsic width), so a wide
        // descendant (a data table, a long unbroken string) forces this
        // whole inset — and with it the page — wider than the viewport
        // instead of the content scrolling within its own container.
