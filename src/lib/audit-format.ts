...
const FIELD_LABELS: Record<string, string> = {
  ...
  mfaEnabled: "MFA",
  smsRemindersEnabled: "SMS/call reminders",
  active: "Active",
  ...
  contactNotes: "Other contact notes",
  emergencyContactName: "Emergency contact",
  emergencyContactRelationship: "Emergency contact relationship",
  emergencyContactPhone: "Emergency contact phone",
  careNotes: "Care needs & medical notes",
...
const ACTION_VERBS: Record<string, string> = {
  ...
  add_client_owner: "Added an owner",
  ...
  edit_break_entry: "Edited a break entry",
  save: "Saved",
  pay: "Paid via Wise",
...
export function formatEventDescription(
  ...
  if (action === "add_client_owner" && newValue) return `Added owner "${newValue}"`;
  if (action === "update_client_owner" && newValue) return `Updated owner "${newValue}"`;
  if (action === "remove_client_owner" && oldValue) return `Removed owner "${oldValue}"`;
